 ...
 * 
 * @param {string} text - Vietnamese text to slugify
 * @returns {string} URL-friendly slug
 * 
 * @example
 * slugify("Sắt thép") // returns "sat-thep"
 * slugify("Linh kiện điện tử") // returns "linh-kien-dien-tu"
 */
 ...
 * @param {string} priceString - Price range string (e.g., '185.000 - 195.000')
 * @returns {number} - The maximum price extracted
 */
export function extractMaxPrice(priceString) {
